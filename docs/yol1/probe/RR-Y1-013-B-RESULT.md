...
> Orchestrator + the maintainer'dadır; aşağıdaki hüküm otomatik-Stage-0-tetikleyici değildir.
>
...
Spec Adım-2 toplu-çekimi MKK VYK API'ye yazıyordu. Koşu-öncesi keşif ölçümü
...
`data/probe/pead_announcement_daydated.parquet` (22.492 satır) — spec §5
